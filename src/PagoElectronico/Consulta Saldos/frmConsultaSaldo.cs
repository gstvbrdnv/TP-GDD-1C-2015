...
namespace PagoElectronico.Consulta_Saldos
{
    public partial class frmConsultaSaldo : Form
    {
        ...
        private void cargarRetiros(string cuenta)
        {
            ...
            {
                columnas[0] = row["fec_retiro"];
                columnas[1] = row["id_retiro"];
                columnas[2] = row["nro_cheque"];
                columnas[3] = row["descripcion"];
                columnas[4] = row["importe"];
        ...
        private void cargarDepositos(string cuenta)
        {
            ...
            foreach (DataRow row in depositos.Rows)
            {
                columnas[0] = row["fec_deposito"];
                columnas[1] = row["id_deposito"];
                columnas[2] = row["importe"];
        ...
        private void cargarTransferencias(string cuenta)
        {
            ...
            {
                columnas[0] = row["fecha"];
                columnas[1] = row["id_transferencia"];
                columnas[2] = row["cta_origen"];
                columnas[3] = row["cta_destino"];
                columnas[4] = row["importe"];
                columnas[5] = row["costo"];
